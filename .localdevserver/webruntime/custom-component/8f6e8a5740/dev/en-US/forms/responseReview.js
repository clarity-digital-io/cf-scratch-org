Webruntime.define('lwc/responseReview', ['lwc', 'c/imageAnswersTable'], function (lwc, _cImageAnswersTable) { 'use strict';

    _cImageAnswersTable = _cImageAnswersTable && Object.prototype.hasOwnProperty.call(_cImageAnswersTable, 'default') ? _cImageAnswersTable['default'] : _cImageAnswersTable;
    ...
    **/
    ...
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      ...
      return [$cmp.loading ? api_custom_element("lightning-spinner", _lightningSpinner, {
        ...
        key: 0
      }, []) : null, api_custom_element("c-image-answers-table", _cImageAnswersTable, {
        props: {
          "keyField": "id",
          "data": $cmp.data,
