...
declare module "@salesforce/schema/Account.forms__Checklist_Group__r" {
  const forms__Checklist_Group__r:any;
  export default forms__Checklist_Group__r;
}
declare module "@salesforce/schema/Account.forms__Checklist_Group__c" {
